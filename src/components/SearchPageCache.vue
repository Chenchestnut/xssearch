...
<template>
  <div class="searchPageCache">
    ...
    <div class="productCache">
        <CacheCard v-for="(item,index) in searchStore.matched_products_count" :key="index"  :img="searchStore.matched_products[index].img" :name="searchStore.matched_products[index].name" :spe="searchStore.matched_products[index].specifications" @click="handleAnalysis(index)"/>
    </div>
